...
(function ($) {
    ...
    $(function () {
        ...
        if ($("html").hasClass("one-page-layout")) {
            ...
            $.address.change(function () {
                ...
                if (detailUrl !== -1) {
                    ...
                    if (
                        $.address.path().indexOf("/" + portfolioKeyword) !== -1
                    ) {
                        if (porftolioSingleActive) {
                            ...
                            if (
                                $(".one-page-content .content-wrap").is(
                                    ":empty"
                                )
                            ) {
                                setActivePage();
        ...
        $("body").on(
            "click",
            ".portfolio-items .media-cell-desc h3",
            function () {
                $(this)
                    .parent()
                    .siblings(".media-box")
    ...
    function homeMusic() {
        ...
        if (music !== null) {
            ...
            music.onpause = function () {
                ...
                document
                    .getElementById("music-animation")
                    .classList.remove("on");
            };
            ...
            // autoplay
            if (
                music_toggle.hasClass("autoplay") &&
                isUserTurnedOffMusic !== true
            ) {
                music_toggle.click();
            } else {
    ...
    function setupMasonry() {
        var masonry = $(
            ".masonry, .gallery, .wp-block-gallery:not(.is-cropped)"
        );
        if (masonry.length) {
            ...
            masonry.each(function (index, el) {
                ...
                if ($(el).data("isotope")) {
                    ...
                    items.each(function (index, element) {
                        var multiplier =
                            $(this).hasClass("x2") && columns > 1 ? 2 : 1;
                        var itemRealWidth =
                            ((Math.floor(containerW / columns) * 100) /
                                containerW) *
                            multiplier;
            ...
            $(".media-box, .gallery, .wp-block-gallery").each(function (
                ...
                $media_box.magnificPopup({
                    ...
                    gallery: {
                        enabled: true,
                        tCounter:
                            '<span class="mfp-counter">%curr% / %total%</span>', // markup of counter
                    },
                    iframe: {
                        markup:
                    ...
                    callbacks: {
                        markupParse: function (template, values, item) {
                            ...
                            if (item.el.parents(".gallery-item").length) {
                                ...
                                item.el.parents(".blocks-gallery-item").length
                            ) {
                                // Gutenberg gallery
                                title = item.el
                        ...
                        beforeClose: function () {
                            ...
                            if (
                                ...
                                this.content.find('iframe[src*="vimeo.com"]')
                                    .length ||
                                this.content.find('iframe[src*="youtube.com"]')
                                    .length
                            ) {
        ...
        if ($(".toggle").length) {
            ...
            $(".toggle h4").on("click", function () {
                if ($(this).hasClass("active")) {
                    ...
                    //accordion
                    if (
                        $(this).parents(".toggle-group").hasClass("accordion")
                    ) {
                        $(this)
                            .parent()
                            .siblings()
    ...
    function setActivePage() {
        ...
        if (path === "") {
            ...
            if (porftolioSingleJustClosed) {
                ...
                if (giveDetailUrl() === -1) {
                    //porftolioSingleJustClosed = false;
                    var new_url = $("a[data-slug=" + path + "]").data(
                        "file-url"
                    );
                    showPage(new_url);
                }

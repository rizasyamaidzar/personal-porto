...
<body>
    ...
    <div class="home-wrap">
        ...
        <!-- HOME BG IMAGE -->
        <div class="home-bg" style="background-image: url(images/home/fix.png)"></div>
        <!-- HOME BG IMAGE -->
        ...
        <!-- .home-menu -->
        <nav class="home-menu">
            <a href="{{ route('about') }}" data-slug="about">
                <span class="item-name">About</span>
            </a>
            <a href="{{ route('resume') }}" data-slug="resume">
                <span class="item-name">Resume</span>
            </a>
            <a href="{{ route('portofolio') }}" data-slug="portfolio" id="portfolio-link">
        ...
        <audio id="bg-music" loop src="audio/music.mp3"></audio>
        <!-- HOME BG MUSIC -->
